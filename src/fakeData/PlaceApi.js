const locations = [
	{
		id: 1,
		name: "Cox's Bazar",
		image: 'https://i.imgur.com/uuHCGhN.png',
		description:
	...
	},
	{
		id: 4,
		name: 'Sajek Vally',
		image: 'https://i.imgur.com/r30U48y.jpg',
		description:
			'Shajek is one of the best beautiful tourist spot in Bangladesh. Shajek is the big union at Baghachari upazila in Rangamati district. Shajek is basically a name of a river which separates Bangladesh from India. Shajek Vally is situated in the north angle of Rangamati, near the Mizoram border boundary area. Shajek is 1800 ft high from sea lavel. Kachalon and Machalong rivers are famous in this Vally.'
	},
	{
		id: 5,
		name: 'St. Martin Island',
		image: 'https://i.imgur.com/SqgzXFc.jpg',
		description:
